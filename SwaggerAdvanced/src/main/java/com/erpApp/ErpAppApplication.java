...
public class ErpAppApplication implements ApplicationListener<ContextRefreshedEvent>
{
	...
	{
		System.out.println("ErpAppApplication onApplicationEvent \n ");
		Product p = new Product();
		p.setDescription("ghantaaa");
		p.setImageUrl("http://localhost");
		p.setVersion(3);
